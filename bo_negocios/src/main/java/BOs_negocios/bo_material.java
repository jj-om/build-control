...
public class bo_material {
    ...
    // FALTA PONER LOGICA, ESTA EN COORDINADOR NEGOCIO DE PRESENTACION
    public boolean actualizarCantidadRecurso(String nombreMaterial, String unidadPeso, Integer cantidad) {
        return true;
    }
}